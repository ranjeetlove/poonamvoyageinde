<?php $__env->startSection('title','Voyage de Luxe en Inde | Séjour Inde Pas Cher avec Poonam Voyage'); ?>
<?php $__env->startSection('description',"Explorez l'Inde avec style grâce à nos voyages de luxe ou découvrez des séjours économiques adaptés à votre budget. Poonam Voyage vous propose des expériences personnalisées et authentiques."); ?>
<?php $__env->startSection('keywords','Voyage de luxe en Inde, Séjour Inde pas cher'); ?>
...
<section id="about" class="about-section pt-100 pb-70">
         ...
         <div class="col-lg-4">
            <div class="video-content mb-30">
               <div class="video-image">
                  <img src="<?php echo e(asset('frontend/assets/img/about1.jpg')); ?>" alt="video" />
               </div>
            </div>
         </div>
         <div class="col-lg-8">
               ...
               <form action="<?php echo e(route('store')); ?>"  enctype="multipart/form-data" method="post">
                  ...
                  <div class="row">
                     ...
                     <div class="col-sm-12 col-md-6 col-xs-12">
                        ...
                        <div class="input-group">
                           <input type="email" class="form-control" name="email" placeholder="Votre adresse e-mail" required="required" />
                        </div>
                     </div>
                     <div class="col-sm-12 col-md-6 col-xs-12">
                        <label>Mobile</label>
                        <div class="input-group">
                           <input type="tel" class="form-control" name="phone" placeholder="Votre numéro de mobile" required="required" />
                        </div>
                     </div>
                  </div>
   ...
   <div class="shape shape-1">
      <img src="<?php echo e(asset('frontend/assets/img/shape1.png')); ?>" alt="Background Shape">
   </div>
   <div class="shape shape-2">
      <img src="<?php echo e(asset('frontend/assets/img/shape2.png')); ?>" alt="Background Shape">
   </div>
</section>
<hr>
               ...
               <div class="row">
                  <div class="col-12">
                     ...
                     <p>Un voyage ne prend pas nécessairement une forme fixe. Vous avez le droit d'être unique et de vous démarquer, à certains moments du parcours et de sortir des sentiers battus.
                        Ne serait-ce qu'une petite touche d'originalité qui se révélera être une découverte n'apparaissant sur aucun prospectus. C'est ce que Poonam Voyage est en mesure de vous offrir: une expérience “sur mesure”, rien que pour vous, à travers une Inde incroyable. 
                     </p>
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gwtknmarcjhd/public_html/resources/views/frontend/tailor-made-trip.blade.php ENDPATH**/ ?>
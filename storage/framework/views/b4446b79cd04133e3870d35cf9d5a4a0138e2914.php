...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="<?php echo e(asset('admin/css/style.min.css')); ?>">
...
<nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                  <img src="<?php echo e(asset('frontend/assets/img/logo/logo.jfif')); ?>" width="30px"> Poonam Voyage Inde
                </a>
            </div>
        </nav>
<div class="wrapper">
...
<?php /**PATH /home/gwtknmarcjhd/public_html/resources/views/admin/layouts/auth.blade.php ENDPATH**/ ?>
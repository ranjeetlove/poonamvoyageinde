										...
										<table cellpadding="0" cellspacing="0" style="width: 100%; border: 1px solid #ededed">
											<tbody>
												<tr>
													...
													<td style="padding: 10px; border-bottom: 1px solid #ededed; color: #455056;"> <?php echo e($name); ?> </td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td style="padding: 10px; border-bottom: 1px solid #ededed; color: #455056;"><?php echo e($mobile); ?></td>
												</tr>
												<tr>
													...
													<td style="padding: 10px; border-bottom: 1px solid #ededed; color: #455056;"><?php echo e($whatsapp); ?></td>
												</tr>
                                                <tr>
													...
													<td style="padding: 10px; border-bottom: 1px solid #ededed; color: #455056;"> <?php echo e($subject); ?> </td>
												</tr>
												<tr>
													<td style="padding: 10px; border-right: 1px solid #ededed; width: 35%;font-weight:500; color:rgba(0,0,0,.64)"> Message :</td>

												  <td style="padding: 10px; color: #455056;"> <?php echo e($messagess); ?>  </td>
...
<?php /**PATH /home/gwtknmarcjhd/public_html/resources/views/frontend/enquery.blade.php ENDPATH**/ ?>
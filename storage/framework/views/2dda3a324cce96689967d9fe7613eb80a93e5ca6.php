<?php $__env->startSection('title','voyage sur mesure au rajasthan
 | voyage sur mesure en inde du nord
'); ?>
<?php $__env->startSection('description','agence de voyage locale en inde  C est une agence de voyage réputée avec des bureaux à Jodhpur Inde du nord , 
'); ?>
                 ...
                 <div class="about-content">
                    <div class="row">
                       <div class="col-12">
                          ...
                          <!--<h6><?php echo e($about->about_head); ?></h6>-->
                          <!--<div class="image">
                                     <img src="<?php echo e(asset('/uploads/abouts/ab2.jpeg')); ?>" alt="Demo Image">
                          </div>-->
                            ...
                            <div class="col-lg-8 col-sm-6 col-md-6">
                              <div class="item-single mb-30" style="height:auto">
                                  <div class="image" style="height:auto">
                                     <img src="<?php echo e(asset('/uploads/abouts/'. $about->image)); ?>" alt="Demo Image">
                                  </div>
                                  <!-- <div class="content">
                                     <div class="title">
                                        <h3>
                                           <a href="#"><?php echo e($about->name); ?></a>
                                        </h3>
                                        <span><?php echo e($about->designation); ?></span>
                                     </div> -->
...
<!-- 
             ...
             <div class="col-lg-6">
                <div class="about-content mb-30">
                   ...
                   <p><?php echo e($about->about_owner); ?></p>
                   <div class="row">
                  ...
                  <!-- <div class="about-btn">
                      ...
                      <a href="<?php echo e(route('contactus')); ?>" class="btn-primary">Contactez Nous</a>
                       </div>-->
                </div>
             </div>
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gwtknmarcjhd/public_html/resources/views/frontend/about-us.blade.php ENDPATH**/ ?>
            ...
            <div class="col-xl-6 col-lg-7">
               <div class="contact-info">
                  ...
                  <div class="content">
                     ...
                     <span class="__cf_email__">poonamvoyageinde@gmail.com</span></a>
                  </div>
               ...
               <div class="side-option">
                  <div class="item">
					  ...
					  <a href="https://in.pinterest.com/poonamvoyageinde90/" target="_blank">
                             <img src="https://convertkit.com/images/social-icons/pinterest.png" alt="pinterest"  style="text-decoration: none; width: 28px;"></a>
                        <a href="https://web.whatsapp.com/send?phone=919818153249&text=Hello%20I%20would%20like%20to%20know%20more%20about%20Our%20Destinations%20For%20Your%20Tailor-Made Trips%20(Poonam%20Voyage)" target="_blank">
                             <img src="<?php echo e(asset('frontend/assets/img/whatsapp.png')); ?>" alt="pinterest"  style="text-decoration: none; width: 30px;"></a>     

                  </div>
                  <div class="item">
                     <a href="<?php echo e(route('contactus')); ?>" class="btn-secondary">
                    Renseignez-vous maintenant <i class='bx bx-phone'></i>
                     </a>
                  </div>
         ...
         <div class="container">
            <div class="main-responsive-menu">
               <div class="logo">
                  ...
                  <img src="<?php echo e(asset('frontend/assets/img/logo/mlogo.png')); ?>" class="logo1" alt="Logo" width="120">
                  <img src="<?php echo e(asset('frontend/assets/img/logo/mlogo.png')); ?>" class="logo2" alt="Logo" width="120">
                  </a>
               </div>
            ...
            <nav class="navbar navbar-expand-md navbar-light">
               ...
               <div class="collapse navbar-collapse mean-menu">
                  <ul class="navbar-nav ms-auto">
                     ...
                     <li class="nav-item">
                        <a href="<?php echo e(route('index')); ?>" class="nav-link active">ACCUEIL</a>
                     </li>
                      ...
                      <li class="nav-item">
                        ...
                        <ul class="dropdown-menu">
                           <li class="nav-item">
                              <a href="<?php echo e(route('aboutus')); ?>" class="nav-link">QUI SOMMES NOUS</a>
                           </li>
                           <li class="nav-item">
                              <a style="text-transform: uppercase;" href="<?php echo e(route('ourTeams')); ?>" class="nav-link">Nos équipes</a>
                           </li>
                        </ul>
                     </li>
                     ...
                     <li class="nav-item">
                        <a href="#" class="nav-link toggle">DESTINATIONS
<i class='bx bxs-chevron-down'></i></a>
                        <ul class="dropdown-menu">
                           <?php
                        ...
                        <?php $__currentLoopData = $regions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <li class="nav-item">
                              <a href="<?php echo e(route('destinationlist',$rg->slug)); ?>" class="nav-link"> <?php echo e($rg->region); ?></a>
                           </li>
                     ...
                     <li class="nav-item">
                        <a href="<?php echo e(route('tailormadetrip')); ?>" class="nav-link">VOYAGE SUR MESURE EN INDE </a>
                     </li>

                      <li class="nav-item">
                        <a href="<?php echo e(route('comments')); ?>" class="nav-link"> COMMENTAIRES</a>
                     </li>

                        <li class="nav-item">
                        <a href="<?php echo e(route('blog')); ?>" class="nav-link"> Blogs </a>
                     </li>

                        <li class="nav-item">
                        <a href="<?php echo e(route('contactus')); ?>" class="nav-link">CONTACTEZ NOUS</a>
                     </li>


                  </ul>
                 <!-- <div class="cart">
                     <a href="#" class="cart-btn"><i class='bx bx-phone'></i>
...
<!-- Header End -->
<?php /**PATH /home/gwtknmarcjhd/public_html/resources/views/frontend/layout/header.blade.php ENDPATH**/ ?>
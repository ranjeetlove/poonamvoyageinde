       ...
       <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
              ...
              <form enctype="multipart/form-data" role="form" id="myform" method="post" action="<?php echo e(route('blog-edit')); ?>">
                <?php echo csrf_field(); ?>
                 ...
                 <div class="row">
                    <div class="col-sm-12">
                          <div class="form-group mt-2">
                              ...
                              <input type="text" class="form-control" name='posted_by' value="<?php echo e($data->posted_by); ?>" ><br>
                              <input type="text" class="form-control" name='posted_date' value="<?php echo e($data->posted_date); ?>" ><br>
                              ...
                              <input type="text" class="form-control" name='category' value="<?php echo e($data->category); ?>" ><br>
                              <input type="text" class="form-control" name='title' value="<?php echo e($data->title); ?>" ><br>
                              <input type="text" placeholder="meta description" class="form-control" name='meta_description' value="<?php echo e($data->meta_description); ?>"><br>
                              <input type="text" placeholder="meta keywords" class="form-control" name='meta_keywords' value="<?php echo e($data->meta_keywords); ?>" ><br>
                              <textarea rows="20" class="form-control" name="content" required><?php echo e($data->content); ?></textarea>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gwtknmarcjhd/public_html/resources/views/admin/blog/edit.blade.php ENDPATH**/ ?>
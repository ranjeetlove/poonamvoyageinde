...
<?php $__env->startSection('title','contactez-nous agence de voyage locale en Inde | Poonam Voyage Inde
'); ?>
<?php $__env->startSection('description','Remplissez le formulaire pour obtenir des informations Forfaits vacances tout inclus Vous pouvez également nous appeler au 9818153249 ou visiter notre site Web à https://poonamvoyageinde.com/ pour plus de détails.   , 
'); ?>
...
<?php $__env->startSection('content'); ?>
      ...
      <div class="contact-section">
            ...
            <div class="container-fluid p-0">
               ...
               <form action="<?php echo e(route('mail')); ?>" enctype="multipart/form-data" method="post">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gwtknmarcjhd/public_html/resources/views/frontend/contactus.blade.php ENDPATH**/ ?>
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/admin/login')); ?>"> 
                        ...
                        <div class="form-group">
                            <div class="col-md-8 col-md-offset-4">
                                ...
                                <!-- <a class="btn btn-link" href="<?php echo e(url('/admin/password/reset')); ?>">
...
<?php echo $__env->make('admin.layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gwtknmarcjhd/public_html/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>
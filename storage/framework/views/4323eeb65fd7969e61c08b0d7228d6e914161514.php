    ...
    <div class="page-title-area ptb2-100">
        <div class="container">
            <div class="page-title-content">
                ...
                <ul>
                    <li class="item"><a href="<?php echo e(route('index')); ?>">Home</a></li>
            ...
            <div class="row align-items-center">
                                        ...
                                        <div class="item-single mb-30">
                                            ...
                                            <div class="content">
                                                <div class="title">
                                                    <h3>
                                                        <a
                                                            href="#"><?php echo e(!empty($testimonials->name) ? $testimonials->name : ''); ?></a>
                                                    </h3>
                                                    <span>
                                                        <?php echo e(!empty($testimonials->country) ? $testimonials->country : ''); ?>
                ...
                <div class="col-lg-6">
                    <div class="about-content mb-30">
                        <h2><?php echo e(!empty($testimonials->name) ? $testimonials->name : ''); ?></h2>
                        <p><?php echo e(!empty($testimonials->designation) ? $testimonials->designation : ''); ?></p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="about-content">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <h6><?php echo e(!empty($testimonials->comment_head) ? $testimonials->comment_head : ''); ?></h6>
                                <p><?php echo !empty($testimonials->comment_content) ? $testimonials->comment_content : ''; ?>
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gwtknmarcjhd/public_html/resources/views/frontend/comments-details.blade.php ENDPATH**/ ?>
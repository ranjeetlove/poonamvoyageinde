...
<head>
    ...
    <!-- End Google Tag Manager -->
        <title>{{ $homepage->page_title ?? 'Meilleur tour opérateur et agence de voyages en Inde | Réservez des forfaits touristiques maintenant !' }}</title>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta http-equiv="Content-Language" content="fr" />
        <meta name="description" content="{{ $homepage->meta_description ?? 'Tour opérateur en Inde, Poonam Voyage Inde propose des circuits sur mesure avec son agence de voyage indienne experte et francophone.' }}">
        <meta name="keywords" content="{{ $homepage->meta_keywords ?? 'tour opérateur en inde, agence de voyage indienne, inde agence de voyage, agence de voyage inde, agence de voyage locale en inde, Voyage en Inde, Circuit en Inde, Tourisme en Inde, Inde voyage organisé, Visiter l\'Inde' }}">
    <meta name="google-site-verification" content="DSSfB1pNmR5mARV45p9_7cSZgjyk1fNldf3iRx7x400" />

    @if(!empty($homepage) && !empty($homepage->schema))
        <script type="application/ld+json">
            {!! $homepage->schema !!}
        </script> 
    @endif
    @if(!empty($homepage) && !empty($homepage->faq_questions) && count($homepage->faq_questions))
        @php
            $mainEntity = [];
                ...
                <div class="bannerWrapper">
                    <div class="bannerBox">
                        ...
                        <div class="bannerTextWrapper">
                            <h1>{!! $homepage->section1_heading ?? 'Explorez l\'Inde : Voyages inoubliables à des prix irrésistibles !' !!}</h1>
                            <p class="bannerTextTop">{!! $homepage->section1_description ?? "Laissez-vous guider par nos experts francophones à travers l'Inde. Ils vous dévoileront des trésors culturels, partageront des récits historiques fascinants, et offriront des conseils pratiques pour faire de votre aventure un souvenir inoubliable." !!}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 tour-operator-india">
                        <h3 class="h3Heading">{{ $homepage->section2_heading ?? "Tour Opérateur en Inde | Circuits sur mesure en Inde" }}</h3>
                        {!! $homepage->section2_description ?? "En tant qu'agence de guides touristiques en Inde, notre équipe dévouée de guides locaux

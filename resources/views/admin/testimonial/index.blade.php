                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                     <td>{{$row->country}}</td>
                     <td>{{$row->name}}</td>
                     <td><img src="{{ URL::to('/') }}/uploads/testimonials/{{ $row->image }}" alt="" class="img-responsive" width="100%" /></td>
                     ...
                     <td>{{$row->status}}</td>
                      <td>
                        <a href="{{route('testimonial-edit', ['id'=>$row->id]) }}" class="btn"><i class="fas fa-edit" style="color: blue;"></i></a>

      ...
      <div class="container-fluid">
       <div class="row">
        <div class="col-md-12">
          ...
          @endif
          <form role="form" method="post" action="{{ url('admin/pages/'.$page_type.'/edit') }}">
            @csrf
            ...
            <div class="card card-secondary">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <textarea name="schema" class="form-control" rows="5">{{ old('schema', $data->c_schema) }}</textarea>
            ...
            <div class="card card-secondary">
              ...
              <div class="card-body">
                <div id="faq-list">
                  @php
                    $faqQuestions = old('faq_questions', data_get($data->faq, 'questions', []));
                    $faqAnswers = old('faq_answers', data_get($data->faq, 'answers', []));

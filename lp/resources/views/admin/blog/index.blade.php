                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><img src="{{ URL::to('/') }}/uploads/blog/{{ $row->image }}" alt="" class="img-responsive" width="100%" /></td>
                      <td>{{$row->category}}</td>
                      <td>{{$row->title}}</td>
                      <td>{!!$row->content!!}</td>
                      ...
                      <td>{{$row->status}}</td>
                      <td>
                        <a href="{{route('blog-edit', ['id'=>$row->id]) }}" class="btn"><i class="fas fa-edit" style="color: blue;"></i></a>
